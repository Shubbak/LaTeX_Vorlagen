...
\postage    % um eine Briefmarke einzufügen.
            % Die Briefmarke sollte unter dem Namen `marke.pdf` im Verzeichnis sein und
            % das Format Leitz ICON Endlos-Etikett 39 mm haben.

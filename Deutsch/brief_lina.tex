...
% ==============================
% Briefmarke hinzufügen
% ==============================
\usepackage{eso-pic}
\usepackage{graphicx}

\newcommand{\postagefile}{marke.pdf}
\newcommand{\postagewidth}{34mm}   % gewünschte Markenbreite
\newcommand{\postagevshift}{0mm}   % Feinjustierung nach unten/oben

\newcommand{\postage}{%
    \AddToShipoutPictureBG*{%
        \AtPageUpperLeft{%
            \put(
            \LenToUnit{73.2mm},      % horizontale Position
            -\LenToUnit{80mm + \postagevshift}   % vertikale Position
            ){%
                \includegraphics[width=\postagewidth]{\postagefile}%
            }%
        }%
    }%
}
...
% \setkomavar{specialmail}{\includegraphics[trim=16.389mm 22.936mm 14.59mm 12.922mm]{marke.pdf}}
% Dieser Befehl setzt die Briefmarke `marke.pdf` und schneidet sie korrekt.
% Die Maße nehmen an, dass das Format Leitz ICON Endlos-Etikett 88mm verwendet wird.
...
\setkomavar{fromphone}{+49\,179~596\,4215}
